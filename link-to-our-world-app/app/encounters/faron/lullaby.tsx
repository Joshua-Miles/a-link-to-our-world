...
import { wildsTheme, zeldasLullaby } from "app/shared/testSongs";
    ...
    return (
        <Column flex={1}>
            ...
            {sequnece.isAt('toTheSoil') && <>
                ...
                <Row justifyContent="center">
                    <Speech text="There is good soil to plant Tumblebreeze nearby, I've marked the location on your map" />
                </Row>
                <Row flex={1} justifyContent="center">
                    <Button.Text onPress={sequnece.next}>
                        Next <ArrowRightIcon />
