    ...
    return (
        <Scene>
            ...
            <SpeechStepper
                ...
                groups={[
                    [`${playerName}, welcome to Zora's Domain. This pristine lake shimmers with the steady power of water.`],
                    [`I have marked the location of the Water Temple on your map.`]
                ]}
